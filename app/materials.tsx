...
export default function Materials(){
  ...
  return <main className="materialsPage">
    <header className="topbar"><a className="brand" href="#top"><span className="brandMark"><img className="brandLogo" src="./jbji-logo.webp" fetchPriority="high" loading="eager" alt="暨南大学与伯明翰大学院徽"/></span><span className="brandCopy"><strong>JBJI 课表助手</strong><small>原始资料</small></span></a><div className="headerActions"><ThemePicker/><a className="backToSchedule" href="#top">返回课表</a><a className="mascotDownload" href={`${import.meta.env.BASE_URL}jbji-nailong-guardian.png`} download="暨伯奶龙.png" title="下载奶龙原图（PNG）">JBJI奶龙 <span aria-hidden="true">↓</span></a></div></header>
